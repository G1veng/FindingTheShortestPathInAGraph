...
namespace Graph
{
  partial class Form1
  {
    ...
    private void InitializeComponent()
    {
      ...
      // createVertex
      // 
      this.createVertex.AllowDrop = true;
      this.createVertex.Location = new System.Drawing.Point(41, 12);
      this.createVertex.Name = "createVertex";
      this.createVertex.Size = new System.Drawing.Size(109, 42);
      this.createVertex.TabIndex = 0;
      this.createVertex.Text = "Создать врешину";
      ...
      this.button4.Text = "Алгоритм Форда-Беллмана";
